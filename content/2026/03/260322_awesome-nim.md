...
[^1]: [Haxe](https://haxe.org/)があるにはあるけど、FlashもAdobe Animatorも公式に終了してしまったし、今は使われているのだろうか…？ある意味でActionScript（あるいはECMAScript4）という消えた遺産がHaxeという形で残っているのは嬉しくはあるし、NekoにHashLinkというVMができたり、動きはあるっぽいけど…。