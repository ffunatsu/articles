...
ちなみにこの件を [discussionsで報告してみたところ](https://github.com/jank-lang/jank/discussions/726#discussioncomment-16390940)、詳しくは分析してみないとわからないけれどJITが効いていないわけではないらしくて、パフォーマンスの最適化を今後数ヶ月かけて行うとのこと。期待して良さそうな返事だったので、半年後が楽しみ。手伝える部分があったら手伝いたいけどな。とりあえずjankやClojureで遊んでいよう。