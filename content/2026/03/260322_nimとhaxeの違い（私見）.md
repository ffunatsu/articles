...
一方でnimをC++トランスパイラとしてのシステム言語と捉えるなら、ネットワーク関係に強いのは結構意外な強みなのかなという気がする。Rustが最近WASMターゲットも含めてそういう強みを出してきているけれど、C++は基盤として使われているとはいえアプリ開発言語としてネットワークに強いイメージはあまりないので、こういう部分はnimのPython-likeな部分が活きてきているのかなと思うと興味深いかもしれない。