...
[bat](https://github.com/sharkdp/bat)を使うと、そうしたことは綺麗に解決できる。する。 `cargo install bat` でインストールできるので手軽に使えるし、[Releases](https://github.com/sharkdp/bat/releases)よりバイナリを配置してインストールもできる。
