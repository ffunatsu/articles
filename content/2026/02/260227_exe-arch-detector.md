...
```bash
$ file "/c/Users/fu/apps/lovr-windows-x85_64-0.18.0_with_luasocket/lovr"
/c/Users/fu/apps/lovr-windows-x85_64-0.18.0_with_luasocket/lovr: Zip archive, with extra data prepended
```
