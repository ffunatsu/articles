...
前の記事で結構大々的にV言語の良さとかC2Vのロゼッタストーン的な良さを書いててあれだけど、[odin-c-bindgen](https://github.com/karl-zylinski/odin-c-bindgen)が優れていたため、ぶっちゃけV言語よりも簡単で、特にbindgen部分に触ることはなかった。
